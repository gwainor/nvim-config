return {
  ...
  config = function()
    ...
    vim.keymap.set('n', '<leader>fs', builtin.current_buffer_fuzzy_find, { desc = '[Telescope] Find in current buffer' })
    vim.keymap.set('n', '<leader>fj', '<cmd>lua require("telescope").extensions.gitmoji.gitmoji()<cr>',
